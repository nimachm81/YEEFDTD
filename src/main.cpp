...
#include "Test_FDTD_3D_Nonuniform_AutoGenerated_Json.hpp"

#include "Test_MultiDimArray.hpp"
#include "Test_ThreadedAlgebra.hpp"
#include "Test_ThreadedAlgebra_Performance.hpp"
...
int main(int argc, char** argv) {
    ...
    //test_run_fdtd_3d_nonuniform_autoGenerated_json();

    //TestNumArrayMultithreading_3();
    //Test_threaded_algebra();
    //Test_threaded_algebra_performance();
}
