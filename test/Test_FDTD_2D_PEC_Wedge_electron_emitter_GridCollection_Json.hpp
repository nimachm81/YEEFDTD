...
void test_run_fdtd_2d_pec_wedge_electron_emitter_gridCollection_from_json() {
    ...
    FPNumber pml_r_z1 = z1 + 1.0;
    FPNumber pml_l_z0 = z0 - 1.0;
    FPNumber pml_l_z1 = z0;

    std::size_t numOfSamplesPerUnitLength = 200;
    ...
    FPNumber pml_r_sig_E = 3.0;
    FPNumber pml_r_sig_H = 3.0;
    FPNumber pml_l_sig_E = 3.0;
    FPNumber pml_l_sig_H = 3.0;
