...
void test_run_fdtd_2d_TM_from_json() {
    FPNumber y0 = -5.0;
    FPNumber y1 = 5.0;
    FPNumber z0 = -5.0;
    FPNumber z1 = 5.0;
    ...
    ParameterExtractor::ReplaceStringsInFile("instructions/MaxwellYee2D_TM.json",
                "instructions/processed/MaxwellYee2D_TM_processed.json", str_replacewith);

    ParamFileTranslator fileTranslator("instructions/processed/MaxwellYee2D_TM_processed.json");
