...
#ifndef TEST_FDTD_2D_LARGEPERIODICLATTICE_GAUSSIANPLASMA_TIMESWITCH_GRIDCOLLECTION_JSON
#define TEST_FDTD_2D_LARGEPERIODICLATTICE_GAUSSIANPLASMA_TIMESWITCH_GRIDCOLLECTION_JSON
...
void test_run_fdtd_large_periodic_gaussian_plasma_time_switch_grid_collection_2d_from_json(
    ...
    FPNumber field_entire_z_m_corner_record = -5.9;
    FPNumber field_entire_z_p_corner_record = +5.9;
    ...
    std::string processedFileName =
            std::string("instructions/processed/MaxwellYee2D_LargePeriodicGaussianPlasma_TimeSwitch_GridCollection_processed_") +
            file_suffix + ".json";

    ParameterExtractor::ReplaceStringsInFile("instructions/MaxwellYee2D_LargePeriodicGaussianPlasma_TimeSwitch_GridCollection.json",
...
#endif // TEST_FDTD_2D_LARGEPERIODICLATTICE_GAUSSIANPLASMA_TIMESWITCH_GRIDCOLLECTION_JSON
